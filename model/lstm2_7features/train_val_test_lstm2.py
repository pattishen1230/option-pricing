...
class Feeder(torch.utils.data.Dataset):
    def __init__(self, data_path, train_val_test='train'):
        ...
        features[:, 6] = 0   # 把当前数据里的call price变成0
...
if __name__=="__main__":
    ...
    for file in files:
        ...
        # define a MyLSTM2
        lstm2 = MyLSTM2(7, 64, 6, 1).to(device)
        lstm2.load_state_dict(torch.load('./lstm2_best_models_final/lstm2_best_val_op_money_1.03dte_180.csv-zihaosheng.pth'))
        ...
        best_lstm2 = MyLSTM2(7, 64, 6, 1).to(device)
